...
1. Use the included `research-agent-0.2.9.xpi` (or create it with the packaging command below).
...
zip -X -r research-agent-0.2.9.xpi manifest.json bootstrap.js prefs.js prefs.xhtml prefs-ui.js chrome src locale icons LICENSE README.md
unzip -t research-agent-0.2.9.xpi
```
